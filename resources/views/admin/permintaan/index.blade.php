...
<x-staradmin>
    ...
    @push('script')
                    ...
                    if (item.status === 'menunggu') {
                        ...
                        cardFooter = `
                            <div class="card-footer justify-content-between align-items-center">
                                ...
                                <a href="{{ route('admin.permintaan.edit', ':id') }}".replace(':id', ${item.id}) class="btn btn-xs btn-outline-warning edit">
        ...
        <script>
            ...
            $('body').on('click', '.btn-reject-action', function () {
                var id = $(this).data("id");
            ...
            $('body').on('click', '.btn-batal-action', function () {
                var id = $(this).data("id");
                $('#formInputBatal')[0].reset();
                $('#id_batal').val(id);
                $('#status_angka').val(5);
